...
public class MediaResultsActivity extends ListActivity {
	...
	private FMLocationListener myLocListener;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myLocListener = new FMLocationListener(locationManager,this);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MediaResultsActivity.this,
						StationResultsActivity.class);
				
				Song song = mediaResults.get(position-1);
		...
		thread.start();
		m_ProgressDialog = ProgressDialog.show(MediaResultsActivity.this,
	...
	private void getResults(final String qString) {
		try {
			...
			MediaQuery results = yesapi.getMedia(qString, true);
